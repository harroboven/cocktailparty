             ...
             fluidRow(
               ...
               column(12,
                      wellPanel(
                        p("Table of Content", style = "font-family: 'times'; font-si16pt; font-size: 26pt"),
                        tags$ol(
                          tags$li("Data Description"),
                            p("   - Data Summary"),
                            p("   - Drinks Data Explorer"),
                          tags$li("Network Exploration"),
                            p("   - Exploration by Drinks"),
                               ...
                               verticalLayout(
                                 wellPanel(
                                   ...
                                   sliderInput("drink.explorer.complexity.filter", "Degree of Recipe Complexity",
                                               ...
                                               value = c(median(dt.drinks.filtered$complexity) - 10,
                                                         mean(dt.drinks.filtered$complexity) + 30
                                                         ),
                                               sep = ""
                                               ),
                                   ...
                                   sliderInput("drink.explorer.cost.filter", "Ingredients Cost per Drink",
                                               ...
                                               value = c(median(dt.drinks.filtered$adj_ingredients_cost),
                                                         mean(dt.drinks.filtered$adj_ingredients_cost) + 5
                                                         ),
                                               sep = ""
                                               ),
               ...
               column(4,
                      wellPanel(
                        ...
                        sliderInput("analysis.drinks.complexity.filter", "Degree of Recipe Complexity",
                                    ...
                                    value = c(median(dt.drinks.analysis$complexity) - 10,
                                              mean(dt.drinks.analysis$complexity) + 30
                                    ),
                                    sep = ""
                                    ),
                        ...
                        sliderInput("analysis.drinks.cost.filter", "Ingredients Cost per Drink",
                                    ...
                                    value = c(median(dt.drinks.analysis$adj_ingredients_cost) - 10, 
                                              mean(dt.drinks.analysis$adj_ingredients_cost) + 30
                                              ),
                                    sep = ""
                                    ),
               ...
               column(4,
                      wellPanel(
                        ...
                        sliderInput("analysis.ingredient.price.filter", "Ingredient Price",
                                    ...
                                    value = c(median(dt.ingredients.analysis$adj_ingredient_price) - 10, 
                                              mean(dt.ingredients.analysis$adj_ingredient_price) + 30
                                              ),
                                    sep = ""
                                    )
                        ),
